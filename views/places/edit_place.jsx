...
// VIEW
function edit(data){
    let editeePlace = data.place
    return (
        <Def>
            <h1 className="display-3 mt-3">EDIT: {editeePlace.name}</h1>
            <div className="new-form container">
                <form action={`/places/${editeePlace.id}?_method=PUT`} method="POST">
                    <div className="row">
                    ...
                    <div className="row">
                        ...
                        <div className="form-group col-sm-6">
                            ...
                            <select className="form-select" id='state' name="state" defaultValue={editeePlace.state}>
